...
- Durch [[Energie|Energieaufnahme]] wechseln sie in einen angeregten Zustand 
- Beim Zurückfallen in den Grundzustand wird der aufgenommene Energiebetrag ($\Delta E$) als Licht einer bestimmten [[Wellenlänge]] abgegeben und wird als [[Linienspektrum|Spektrallinie]] sichtbar 
- Obwohl ein [[Wasserstoff]]-[[Atom]] nur ein [[Elektron]] besitzt, zeigt es mehrere Spektrallinien 
- Grund: Das [[Elektron]] kann verschiedene angeregte Zustände einnehmen, beim Zurückfallen entstehen unterschiedliche Energieübergänge und Wellenlängen 
- Elemente mit vielen [[Elektron|Elektronen]] weisen komplexere Spektren mit sehr vielen Spektrallinien auf 
- Die Lage der [[Linienspektrum|Spektrallinien]] ist charakteristisch für jedes Element 
- Energiebeträge und Energiewerte im Atom sind [[Quantelung|gequantelt]] (nur bestimmte diskrete Werte sind möglich). 
- Darstellung im Energiestufenmodell: Zustände werden durch die [[Hauptquantenzahl]] $n$ ($n = 1, 2, 3, \dots$) beschrieben 
- Je größer $n$, desto weiter ist das [[Elektron]] vom [[Atom|Atomkern]] entfernt und desto höher ist seine [[Energie]] 
