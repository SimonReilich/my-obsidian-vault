...
Besondere Fälle von Schranken: [[Supremum]] und [[Infimum]]

# Konventionen
- $sup \space M = \infty$, falls $M$ nicht nach oben beschränkt ist
- $sup \space \emptyset = - \infty$ 
- $inf \space M = - \infty$, falls $M$ nicht nach unten beschränkt
