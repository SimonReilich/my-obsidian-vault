...
- Eine Zuweisung $\mathcal{A}$ ist eine Funktion $\mathrm{Atome} \to \{0, 1\}$, anhand folgender Regeln erweitern wir zu $\hat{\mathcal{A}}: Formeln \to \{0, 1\}$:$$ \hat{\mathcal{A}}(A_i) = \mathcal{A_i} $$$$\hat{\mathcal{A}}(\neg F) = \begin{cases} 0 & \text{if } \hat{\mathcal{A}}(F) = 1 \\ 1 & \text{otherwise}\end{cases}$$$$\hat{\mathcal{A}}(F \land G) = \begin{cases} 1 & \text{if } \hat{\mathcal{A}}(F) = \hat{\mathcal{A}}(G) = 1 \\ 0 & \text{otherwise} \end{cases}$$$$\hat{\mathcal{A}}(F \lor G) = \begin{cases} 0 & \text{if } \hat{\mathcal{A}}(F) = \hat{\mathcal{A}}(G) = 0 \\ 1 & \text{otherwise} \end{cases}$$$$\hat{\mathcal{A}}(F \implies G) = \hat{\mathcal{A}}(\neg F \lor G)$$$$\hat{\mathcal{A}}(F \iff G) = \hat{\mathcal{A}}((F \implies G) \land (G \implies F))$$
- Besondere Fälle: $\lor_{i = 0}^0 F_i = \lor \emptyset = \bot$, $\land_{i = 0}^0 F_i = \land \emptyset = \top$ 
- [[Koinzidenzlemma]] 
- Definition von [[Modell|Modellen]] 